      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View style={{flex: 1, flexDirection: 'column'}}>
          <View style={styles.container}>
            <Text style={{fontSize: 36, color: '#008000' }}>BE$T BET</Text>
            ...
            <View style={{height: 40, flexDirection: 'row', alignContent: 'center', justifyContent: 'center'}}>
              ...
              />
              <Text style={{flex: 1, height: 40, paddingTop: 10, paddingLeft: 10, maxWidth: 100}}
            ...
            <Modal isVisible={this.state.isUnitModalOpen}
              ...
              <View>
                ...
                <TouchableOpacity onPress={this.openUnitPicker.bind(this)}>
                  <Text style={{
                    fontSize: 12, marginLeft: 'auto', marginRight: 'auto', marginBottom: 10}}>
                    Close
                  </Text>
                </TouchableOpacity>
              </View>
